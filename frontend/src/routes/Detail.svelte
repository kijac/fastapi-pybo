        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="badge bg-light text-dark p-2 text-start">
                    ...
                    <div>
                    {moment(question.create_date).format("YYYY년 MM월 DD일 HH:mm 작성")}</div>
                </div>
            </div>
            <div class="my-3">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="badge bg-light text-dark p-2 text-start">
                    ...
                    <div>
                    {moment(answer.create_date).format("YYYY년 MM월 DD일 HH:mm 작성")}</div>
                </div>
            </div>
            <div class="my-3">
                <button class="btn btn-sm btn-outline-secondary"
...
<Error error={error} />
<form method="post" on:submit={post_answer}>
